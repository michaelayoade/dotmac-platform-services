...
class TestJWTRevocation:
    ...
    def test_is_token_revoked_sync(self, jwt_service):
        ...
        with patch('dotmac.platform.caching.get_redis') as mock_get_redis:
...
class TestAuthenticationDependencyFix:
    ...
    @pytest.mark.asyncio
    async def test_get_current_user_bearer_token_revoked(self, jwt_service_mock, api_key_service_mock):
    ...
    @pytest.mark.asyncio
    async def test_get_current_user_oauth_token_revoked(self, jwt_service_mock, api_key_service_mock):
    ...
    @pytest.mark.asyncio
    async def test_get_current_user_valid_token_success(self, jwt_service_mock, api_key_service_mock):
    ...
    @pytest.mark.asyncio
    async def test_get_current_user_uses_async_verification(self, jwt_service_mock, api_key_service_mock):
        ...
        with patch('dotmac.platform.auth.core.jwt_service', jwt_service_mock):
            with patch('dotmac.platform.auth.core.api_key_service', api_key_service_mock):
                ...
                assert not hasattr(jwt_service_mock, 'verify_token') or not jwt_service_mock.verify_token.called
...
class TestAuthRouterFixes:
    ...
    @pytest.mark.asyncio
    async def test_logout_with_proper_cleanup(self, mock_jwt_service, mock_session_manager):
    ...
    @pytest.mark.asyncio
    async def test_refresh_token_revokes_old_token(self, mock_jwt_service):
        """Test refresh token flow revokes old refresh token."""
        from dotmac.platform.auth.router import refresh_token, RefreshTokenRequest
