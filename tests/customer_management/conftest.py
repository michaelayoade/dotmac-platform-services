...
def _build_customer_kwargs(
    *,
    ...
    base_kwargs: dict[str, Any] = {
        ...
        "last_mile_technology": "cloud",
        "service_plan_speed": "Pro",
        "assigned_devices": {
            "device_id": f"DEV{index:04d}",
            "router_id": f"RTR{index:04d}",
        },
        "current_bandwidth_profile": "enterprise",
...
def sample_customer_dict() -> dict[str, Any]:
    ...
    return {
        ...
        "service_address_line1": "123 Cloud Ave",
        "service_address_line2": "Unit A",
        "service_city": "San Francisco",
        "service_state_province": "CA",
        "service_postal_code": "94105",
        ...
        "last_mile_technology": "cloud",
        "service_plan_speed": "Pro",
        "assigned_devices": {"device_id": "DEV0001", "router_id": "RTR0001"},
        "current_bandwidth_profile": "enterprise",
