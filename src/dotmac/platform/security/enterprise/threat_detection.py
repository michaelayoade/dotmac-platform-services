...
class ThreatDetector:
    ...
    async def analyze_login_attempt(
        ...
        if not success:
            ...
            self._failed_login_attempts[user_id] = [
                t for t in self._failed_login_attempts[user_id] if t > cutoff_time
            ]
    ...
    async def analyze_api_usage(
        ...
        self._rate_limit_violations[rate_key] = [
            t for t in self._rate_limit_violations[rate_key] if t > cutoff_time
        ]
