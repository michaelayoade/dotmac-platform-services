...
describe('UI Utils (Deprecated)', () => {
  ...
  describe('Type definitions', () => {
    it('should have correct PortalType union', () => {
      const validPortals: PortalType[] = ['admin', 'customer', 'reseller', 'technician', 'management'];
    ...
    it('should have correct PortalColorType structure', () => {
      const config = getPortalConfig('admin');
      const expectedKeys: (keyof PortalColorType)[] = ['primary', 'secondary', 'accent', 'background', 'text'];
