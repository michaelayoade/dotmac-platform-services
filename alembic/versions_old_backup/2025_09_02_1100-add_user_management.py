...
def upgrade() -> None:
    ...
    # Create enum types
    op.execute(
        "CREATE TYPE user_type_enum AS ENUM ('customer', 'technician', 'isp_admin', 'isp_support', 'super_admin', 'platform_admin', 'tenant_admin', 'tenant_user', 'platform_support', 'api_user', 'readonly', 'reseller', 'partner')"
    )
    op.execute(
        "CREATE TYPE user_status_enum AS ENUM ('pending', 'active', 'inactive', 'suspended', 'locked', 'expired', 'deleted', 'archived')"
    )
    op.execute("CREATE TYPE session_type_enum AS ENUM ('web', 'mobile', 'api', 'cli', 'system')")
    op.execute(
        "CREATE TYPE auth_provider_enum AS ENUM ('local', 'oauth_google', 'oauth_microsoft', 'saml', 'ldap', 'api_key')"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "created_at", sa.DateTime(), nullable=False, default=sa.text("CURRENT_TIMESTAMP")
        ),
        sa.Column(
            "updated_at", sa.DateTime(), nullable=False, default=sa.text("CURRENT_TIMESTAMP")
        ),
        ...
        sa.Column(
            "preferred_name", sa.String(100), nullable=True, comment="Preferred display name"
        ),
        # Classification
        sa.Column(
            "user_type",
            sa.Enum(name="user_type_enum"),
            nullable=False,
            index=True,
        ...
        sa.Column(
            ...
            nullable=False,
            default=False,
            comment="Phone verification flag",
        ),
        sa.Column(
            "email_verified_at",
            sa.DateTime(),
        ...
        # Settings
        sa.Column(
            "timezone", sa.String(50), nullable=False, default="UTC", comment="User timezone"
        ),
        sa.Column(
            "language", sa.String(10), nullable=False, default="en", comment="Preferred language"
        ),
        ...
        sa.Column(
            "login_count", sa.Integer(), nullable=False, default=0, comment="Total login count"
        ),
        sa.Column(
            "failed_login_count",
            sa.Integer(),
        ...
        sa.Column(
            "locked_until", sa.DateTime(), nullable=True, comment="Account locked until timestamp"
        ),
        # Profile Information
        ...
        sa.Column(
            "platform_metadata", sa.JSON(), nullable=True, comment="Platform-specific metadata"
        ),
        # Legal Compliance
        sa.Column(
            "terms_accepted",
            ...
            nullable=False,
            default=False,
            comment="Terms of service accepted",
        ),
        sa.Column(
            "privacy_accepted",
            sa.Boolean(),
        ...
        sa.Column(
            "terms_accepted_at", sa.DateTime(), nullable=True, comment="Terms acceptance timestamp"
        ),
        sa.Column(
            "privacy_accepted_at",
            sa.DateTime(),
            nullable=True,
            comment="Privacy acceptance timestamp",
        ),
    ...
    op.create_table(
        ...
        # Additional Contact
        sa.Column(
            "website", sa.String(500), nullable=True, comment="Personal or professional website"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "profile_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("user_profiles_v2.id"),
            nullable=False,
            unique=True,
        ...
        # Billing Address
        sa.Column(
            "billing_address_line1", sa.String(200), nullable=True, comment="Billing address line 1"
        ),
        sa.Column(
            "billing_address_line2", sa.String(200), nullable=True, comment="Billing address line 2"
        ),
        sa.Column("billing_city", sa.String(100), nullable=True, comment="Billing city"),
        sa.Column(
            "billing_state", sa.String(100), nullable=True, comment="Billing state or province"
        ),
        sa.Column(
            "billing_postal_code", sa.String(20), nullable=True, comment="Billing postal/ZIP code"
        ),
    ...
    op.create_table(
        ...
        # UI Preferences
        sa.Column(
            "theme", sa.String(20), nullable=False, default="light", comment="UI theme preference"
        ),
        sa.Column(
            "date_format",
            sa.String(20),
        ...
        sa.Column(
            ...
            nullable=False,
            default=True,
            comment="Security alert notifications",
        ),
        sa.Column(
            "account_updates",
            sa.Boolean(),
            nullable=False,
            default=True,
            comment="Account update notifications",
        ),
        sa.Column(
            "system_maintenance",
            sa.Boolean(),
        ...
        sa.Column(
            ...
            nullable=False,
            default=False,
            comment="Marketing email notifications",
        ),
        # Privacy Settings
        sa.Column(
            "profile_visibility",
        ...
        # Custom Preferences
        sa.Column(
            "dashboard_layout", sa.JSON(), nullable=True, comment="Dashboard layout preferences"
        ),
        sa.Column(
            "custom_preferences", sa.JSON(), nullable=True, comment="Custom user preferences"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "salt", sa.String(255), nullable=True, comment="Password salt for additional security"
        ),
        sa.Column(
            "algorithm",
            sa.String(50),
        ...
        sa.Column(
            "reset_token_expires", sa.DateTime(), nullable=True, comment="Reset token expiry"
        ),
        sa.Column(
            "reset_attempts",
            sa.Integer(),
    ...
    op.create_table(
        ...
        sa.Column(
            "password_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("user_passwords_v2.id"),
            nullable=False,
            comment="Reference to current password record",
        ),
        # Password Information
        sa.Column(
            "password_hash", sa.String(255), nullable=False, comment="Historical password hash"
        ),
        ...
        sa.Column(
            "change_reason", sa.String(100), nullable=True, comment="Reason for password change"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "session_type",
            sa.Enum(name="session_type_enum"),
            nullable=False,
            default="web",
        ...
        sa.Column(
            "auth_provider",
            sa.Enum(name="auth_provider_enum"),
            nullable=False,
            default="local",
        ...
        # Client Information
        sa.Column(
            "client_ip", sa.String(45), nullable=True, comment="Client IP address"
        ),  # IPv6 support
        sa.Column("user_agent", sa.Text(), nullable=True, comment="Client user agent string"),
        sa.Column(
            "device_fingerprint", sa.String(255), nullable=True, comment="Device fingerprint hash"
        ),
        # Geographic Information
        ...
        sa.Column(
            "terminated_at", sa.DateTime(), nullable=True, comment="Session termination timestamp"
        ),
        sa.Column(
            "termination_reason",
            sa.String(100),
        ...
        # Session Metadata
        sa.Column(
            "session_metadata", sa.JSON(), nullable=True, comment="Additional session metadata"
        ),
    ...
    op.create_index(
        "idx_user_sessions_v2_user_active", "user_sessions_v2", ["user_id", "is_active"]
    )
