...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_customer_tenants_status"), "customer_tenants", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_customer_tenants_subdomain"), "customer_tenants", ["subdomain"], unique=True
    )
    op.create_index(
        op.f("ix_customer_tenants_tenant_id"), "customer_tenants", ["tenant_id"], unique=True
    )
    op.create_table(
        ...
        sa.Column(
            "cloud_provider",
            sa.Enum("AWS", "AZURE", "GCP", "DIGITALOCEAN", "KUBERNETES", name="cloudprovider"),
            nullable=False,
        ),
        sa.Column(
            "resource_tier",
            sa.Enum("MICRO", "SMALL", "MEDIUM", "LARGE", "XLARGE", name="resourcetier"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_infrastructure_templates_cloud_provider"),
        "infrastructure_templates",
        ["cloud_provider"],
        unique=False,
    )
    op.create_index(
        op.f("ix_infrastructure_templates_id"), "infrastructure_templates", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_infrastructure_templates_is_active"),
        "infrastructure_templates",
        ["is_active"],
        unique=False,
    )
    op.create_index(
        op.f("ix_infrastructure_templates_is_deleted"),
        "infrastructure_templates",
        ["is_deleted"],
        unique=False,
    )
    op.create_index(
        op.f("ix_infrastructure_templates_name"), "infrastructure_templates", ["name"], unique=False
    )
    op.create_index(
        op.f("ix_infrastructure_templates_resource_tier"),
        "infrastructure_templates",
        ["resource_tier"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_plugin_categories_is_active"), "plugin_categories", ["is_active"], unique=False
    )
    op.create_index(
        op.f("ix_plugin_categories_is_deleted"), "plugin_categories", ["is_deleted"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "plan_type",
            sa.Enum("FIXED", "USAGE_BASED", "TIERED", "HYBRID", name="pricingplantype"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_pricing_plans_is_active"), "pricing_plans", ["is_active"], unique=False
    )
    op.create_index(
        op.f("ix_pricing_plans_is_deleted"), "pricing_plans", ["is_deleted"], unique=False
    )
    op.create_index(op.f("ix_pricing_plans_name"), "pricing_plans", ["name"], unique=False)
    op.create_index(
        op.f("ix_pricing_plans_plan_type"), "pricing_plans", ["plan_type"], unique=False
    )
    op.create_index(op.f("ix_pricing_plans_slug"), "pricing_plans", ["slug"], unique=True)
    op.create_index(
        op.f("ix_pricing_plans_stripe_price_id"), "pricing_plans", ["stripe_price_id"], unique=False
    )
    op.create_table(
        "users",
    ...
    op.create_index(
        op.f("ix_deployments_cloud_provider"), "deployments", ["cloud_provider"], unique=False
    )
    op.create_index(
        op.f("ix_deployments_domain_name"), "deployments", ["domain_name"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_deployments_resource_tier"), "deployments", ["resource_tier"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "DEPRECATED", "DISCONTINUED", name="pluginstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_subscriptions_current_period_start"),
        "subscriptions",
    ...
    op.create_index(
        op.f("ix_subscriptions_is_deleted"), "subscriptions", ["is_deleted"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_user_invitations_expires_at"), "user_invitations", ["expires_at"], unique=False
    )
    op.create_index(op.f("ix_user_invitations_id"), "user_invitations", ["id"], unique=False)
    op.create_index(
        op.f("ix_user_invitations_invitation_token"),
        "user_invitations",
        ["invitation_token"],
        unique=True,
    )
    op.create_index(
        op.f("ix_user_invitations_is_deleted"), "user_invitations", ["is_deleted"], unique=False
    )
    op.create_index(
        op.f("ix_user_invitations_tenant_id"), "user_invitations", ["tenant_id"], unique=False
    )
    op.create_table(
        "user_sessions",
    ...
    op.create_index(
        op.f("ix_user_sessions_is_deleted"), "user_sessions", ["is_deleted"], unique=False
    )
    op.create_index(
        op.f("ix_user_sessions_refresh_token"), "user_sessions", ["refresh_token"], unique=True
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_vps_customers_customer_id"), "vps_customers", ["customer_id"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "severity",
            sa.Enum("INFO", "WARNING", "CRITICAL", "EMERGENCY", name="alertseverity"),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "ACKNOWLEDGED", "RESOLVED", "SUPPRESSED", name="alertstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_deployment_events_event_type"), "deployment_events", ["event_type"], unique=False
    )
    op.create_index(op.f("ix_deployment_events_id"), "deployment_events", ["id"], unique=False)
    op.create_index(
        op.f("ix_deployment_events_is_deleted"), "deployment_events", ["is_deleted"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_deployment_resources_deployment_id"),
        "deployment_resources",
        ["deployment_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_deployment_resources_id"), "deployment_resources", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_deployment_resources_is_deleted"),
        "deployment_resources",
        ["is_deleted"],
        unique=False,
    )
    op.create_index(
        op.f("ix_deployment_resources_resource_type"),
        "deployment_resources",
        ["resource_type"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("HEALTHY", "WARNING", "CRITICAL", "UNKNOWN", name="healthstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_health_checks_check_name"), "health_checks", ["check_name"], unique=False
    )
    op.create_index(
        op.f("ix_health_checks_check_type"), "health_checks", ["check_type"], unique=False
    )
    op.create_index(
        op.f("ix_health_checks_deployment_id"), "health_checks", ["deployment_id"], unique=False
    )
    op.create_index(op.f("ix_health_checks_id"), "health_checks", ["id"], unique=False)
    op.create_index(
        op.f("ix_health_checks_is_deleted"), "health_checks", ["is_deleted"], unique=False
    )
    op.create_index(
        op.f("ix_health_checks_next_check_at"), "health_checks", ["next_check_at"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_health_checks_tenant_id"), "health_checks", ["tenant_id"], unique=False
    )
    op.create_table(
        "invoices",
        ...
        sa.Column(
            "status",
            sa.Enum(
                "DRAFT", "SENT", "PAID", "OVERDUE", "CANCELLED", "REFUNDED", name="invoicestatus"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_invoices_stripe_invoice_id"), "invoices", ["stripe_invoice_id"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "metric_type",
            sa.Enum("COUNTER", "GAUGE", "HISTOGRAM", "SUMMARY", name="metrictype"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "license_tier",
            sa.Enum("FREE", "BASIC", "PREMIUM", "ENTERPRISE", name="licensetier"),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum("TRIAL", "ACTIVE", "SUSPENDED", "EXPIRED", "CANCELLED", name="licensestatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_plugin_licenses_expires_at"), "plugin_licenses", ["expires_at"], unique=False
    )
    op.create_index(op.f("ix_plugin_licenses_id"), "plugin_licenses", ["id"], unique=False)
    op.create_index(
        op.f("ix_plugin_licenses_is_deleted"), "plugin_licenses", ["is_deleted"], unique=False
    )
    op.create_index(
        op.f("ix_plugin_licenses_license_key"), "plugin_licenses", ["license_key"], unique=False
    )
    op.create_index(
        op.f("ix_plugin_licenses_license_tier"), "plugin_licenses", ["license_tier"], unique=False
    )
    op.create_index(
        op.f("ix_plugin_licenses_plugin_id"), "plugin_licenses", ["plugin_id"], unique=False
    )
    op.create_index(op.f("ix_plugin_licenses_status"), "plugin_licenses", ["status"], unique=False)
    op.create_index(
        op.f("ix_plugin_licenses_tenant_id"), "plugin_licenses", ["tenant_id"], unique=False
    )
    op.create_table(
        "sla_records",
        sa.Column("tenant_id", GUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_sla_records_deployment_id"), "sla_records", ["deployment_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_sla_records_period_start"), "sla_records", ["period_start"], unique=False
    )
    op.create_index(op.f("ix_sla_records_tenant_id"), "sla_records", ["tenant_id"], unique=False)
    op.create_table(
        "vps_deployment_events",
    ...
    op.create_index(
        op.f("ix_vps_deployment_events_event_id"),
        "vps_deployment_events",
        ["event_id"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_vps_support_tickets_ticket_id"), "vps_support_tickets", ["ticket_id"], unique=True
    )
    op.create_table(
        "commissions",
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "APPROVED", "PAID", "CANCELLED", name="commissionstatus"),
            nullable=False,
        ),
        sa.Column("period_start", sa.DateTime(), nullable=False),
        sa.Column("period_end", sa.DateTime(), nullable=False),
    ...
    op.create_index(
        op.f("ix_commissions_reseller_id"), "commissions", ["reseller_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_plugin_usage_is_deleted"), "plugin_usage", ["is_deleted"], unique=False
    )
    op.create_index(
        op.f("ix_plugin_usage_license_id"), "plugin_usage", ["license_id"], unique=False
    )
    op.create_index(op.f("ix_plugin_usage_plugin_id"), "plugin_usage", ["plugin_id"], unique=False)
    op.create_index(
        op.f("ix_plugin_usage_usage_date"), "plugin_usage", ["usage_date"], unique=False
    )
    op.create_index(
        op.f("ix_plugin_usage_usage_type"), "plugin_usage", ["usage_type"], unique=False
    )
    op.create_table(
        "usage_records",
        sa.Column("subscription_id", GUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_usage_records_is_deleted"), "usage_records", ["is_deleted"], unique=False
    )
    op.create_index(
        op.f("ix_usage_records_metric_name"), "usage_records", ["metric_name"], unique=False
    )
    op.create_index(
        op.f("ix_usage_records_subscription_id"), "usage_records", ["subscription_id"], unique=False
    )
    op.create_index(
        op.f("ix_usage_records_usage_date"), "usage_records", ["usage_date"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_infrastructure_templates_resource_tier"), table_name="infrastructure_templates"
    )
    op.drop_index(op.f("ix_infrastructure_templates_name"), table_name="infrastructure_templates")
    op.drop_index(
        op.f("ix_infrastructure_templates_is_deleted"), table_name="infrastructure_templates"
    )
    op.drop_index(
        op.f("ix_infrastructure_templates_is_active"), table_name="infrastructure_templates"
    )
    op.drop_index(op.f("ix_infrastructure_templates_id"), table_name="infrastructure_templates")
    op.drop_index(
        op.f("ix_infrastructure_templates_cloud_provider"), table_name="infrastructure_templates"
    )
