...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('assigned_team_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('teams.id'), nullable=True),
    ...
    op.create_index('ix_contact_label_definitions_tenant_id', 'contact_label_definitions', ['tenant_id'])
    ...
    op.create_table(
        ...
        sa.Column('label_definition_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('contact_label_definitions.id', ondelete='CASCADE'), primary_key=True),
    ...
    op.create_index('ix_contact_labels_label_definition_id', 'contact_to_labels', ['label_definition_id'])
    ...
    op.create_index('ix_contact_field_definitions_tenant_id', 'contact_field_definitions', ['tenant_id'])
    op.create_index('ix_contact_field_definitions_field_key', 'contact_field_definitions', ['field_key'])
    op.create_index('ix_contact_field_definitions_field_group', 'contact_field_definitions', ['field_group'])
