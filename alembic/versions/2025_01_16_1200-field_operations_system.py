...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "supervisor_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("field_technicians.id"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            sa.Enum(
                "low", "normal", "high", "urgent", "emergency", name="work_order_priority_enum"
            ),
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column(
            "work_order_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("field_work_orders.id"),
            nullable=False,
        ),
        ...
        sa.Column(
            "changed_at", sa.DateTime, nullable=False, server_default=sa.text("CURRENT_TIMESTAMP")
        ),
    ...
    op.create_index(
        "idx_technicians_tenant_status", "field_technicians", ["tenant_id", "current_status"]
    )
    op.create_index("idx_technicians_skills", "field_technicians", ["tenant_id", "skill_level"])
    op.create_index(
        "idx_technicians_location_update", "field_technicians", ["last_location_update"]
    )
    ...
    op.create_index(
        "idx_workorders_technician_status", "field_work_orders", ["technician_id", "status"]
    )
    op.create_index(
        "idx_workorders_customer_priority", "field_work_orders", ["customer_id", "priority"]
    )
    ...
    op.create_index(
        "idx_equipment_serial_barcode", "work_order_equipment", ["serial_number", "barcode"]
    )

    op.create_index(
        "idx_time_entries_technician_date",
        "technician_time_entries",
        ["technician_id", "start_time"],
    )
    ...
    op.create_index(
        "idx_performance_overall_score", "technician_performance", ["overall_performance_score"]
    )
