...
def upgrade() -> None:
    ...
    op.alter_column(
        "alerts", "id", existing_type=sa.CHAR(length=32), type_=sa.UUID(), existing_nullable=False
    )
    op.alter_column(
        "commissions",
        "reseller_id",
    ...
    op.add_column(
        "customer_tenants", sa.Column("deployment_type", sa.String(length=50), nullable=False)
    )
    ...
    op.add_column(
        "customer_tenants", sa.Column("ssh_username", sa.String(length=100), nullable=True)
    )
    op.add_column("customer_tenants", sa.Column("ssh_key", sa.Text(), nullable=True))
    op.add_column(
        "customer_tenants", sa.Column("ssh_password_hash", sa.String(length=255), nullable=True)
    )
    op.add_column(
        "customer_tenants", sa.Column("custom_domain", sa.String(length=255), nullable=True)
    )
    op.add_column("customer_tenants", sa.Column("expected_customers", sa.Integer(), nullable=True))
    op.add_column(
        "customer_tenants", sa.Column("estimated_traffic", sa.String(length=20), nullable=True)
    )
    op.add_column("customer_tenants", sa.Column("timezone", sa.String(length=50), nullable=True))
    op.add_column(
        "customer_tenants", sa.Column("preferred_backup_time", sa.String(length=10), nullable=True)
    )
    op.add_column(
        "customer_tenants", sa.Column("support_tier", sa.String(length=50), nullable=True)
    )
    op.create_index(
        op.f("ix_customer_tenants_deployment_type"),
        "customer_tenants",
        ["deployment_type"],
        unique=False,
    )
    ...
    op.alter_column(
        "invoices", "id", existing_type=sa.CHAR(length=32), type_=sa.UUID(), existing_nullable=False
    )
    op.alter_column(
        "metrics",
        "tenant_id",
    ...
    op.alter_column(
        "metrics", "id", existing_type=sa.CHAR(length=32), type_=sa.UUID(), existing_nullable=False
    )
    op.alter_column(
        "payments",
        "invoice_id",
    ...
    op.alter_column(
        "payments", "id", existing_type=sa.CHAR(length=32), type_=sa.UUID(), existing_nullable=False
    )
    op.alter_column(
        "plugin_categories",
        "id",
    ...
    op.alter_column(
        "plugins", "id", existing_type=sa.CHAR(length=32), type_=sa.UUID(), existing_nullable=False
    )
    op.alter_column(
        "pricing_plans",
        "id",
    ...
    op.alter_column(
        "users", "id", existing_type=sa.CHAR(length=32), type_=sa.UUID(), existing_nullable=False
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column(
        "users", "id", existing_type=sa.UUID(), type_=sa.CHAR(length=32), existing_nullable=False
    )
    op.alter_column(
        "users",
        "tenant_id",
    ...
    op.alter_column(
        "plugins", "id", existing_type=sa.UUID(), type_=sa.CHAR(length=32), existing_nullable=False
    )
    op.alter_column(
        "plugins",
        "category_id",
    ...
    op.alter_column(
        "payments", "id", existing_type=sa.UUID(), type_=sa.CHAR(length=32), existing_nullable=False
    )
    op.alter_column(
        "payments",
        "invoice_id",
    ...
    op.alter_column(
        "metrics", "id", existing_type=sa.UUID(), type_=sa.CHAR(length=32), existing_nullable=False
    )
    op.alter_column(
        "metrics",
        "deployment_id",
    ...
    op.alter_column(
        "invoices", "id", existing_type=sa.UUID(), type_=sa.CHAR(length=32), existing_nullable=False
    )
    op.alter_column(
        "invoices",
        "subscription_id",
    ...
    op.alter_column(
        "alerts", "id", existing_type=sa.UUID(), type_=sa.CHAR(length=32), existing_nullable=False
    )
    op.alter_column(
        "alerts",
        "resolved_by",
    ...
    op.create_index(
        op.f("ix_vps_deployment_events_event_id"), "vps_deployment_events", ["event_id"], unique=1
    )
    op.create_table(
        "vps_health_checks",
        sa.Column("vps_customer_id", sa.INTEGER(), nullable=False),
    ...
    op.create_index(
        op.f("ix_vps_support_tickets_ticket_id"), "vps_support_tickets", ["ticket_id"], unique=1
    )
    op.create_table(
        "vps_customers",
    ...
    op.create_index(
        op.f("ix_vps_customers_customer_id"), "vps_customers", ["customer_id"], unique=1
    )
    # ### end Alembic commands ###
