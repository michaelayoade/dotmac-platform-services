...
Revision ID: 2025_11_09_1700
Revises: 2025_11_08_1600
...
revision = '2025_11_09_1700'
down_revision = '2025_11_08_1600'  # Update this to the latest migration
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    op.execute('DROP TABLE IF NOT EXISTS "account" CASCADE;')
