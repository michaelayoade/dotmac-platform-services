...
def test_data_transfer():
    ...
    response = requests.post(
        f"{BASE_URL}/api/v1/data-transfer/export",
    ...
    try:
        ...
        response = requests.post(
            f"{BASE_URL}/api/v1/data-transfer/import",
            json={"request": import_request}
        )
...
def test_search():
    ...
    response = requests.post(
        f"{BASE_URL}/api/v1/search/index",
        json=index_request
    )
...
def test_secrets():
    ...
    response = requests.post(
        f"{BASE_URL}/api/v1/secrets/secrets",
        json=secret_data
    )
