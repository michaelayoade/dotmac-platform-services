...
REPLACEMENTS = [
    ...
    (r"from \.\.audit_trail import .*", "from dotmac.platform.logging import log_audit_event"),
    ...
    (r"AuditAggregator", "# AuditAggregator removed - use log_audit_event"),
    (r"get_audit_aggregator", "# get_audit_aggregator removed - use log_audit_event"),
    # Replace audit event logging
    (r"audit_aggregator\.log_event\(", "log_audit_event("),
    (r"self\.audit\.log_event\(", "log_audit_event("),
]
