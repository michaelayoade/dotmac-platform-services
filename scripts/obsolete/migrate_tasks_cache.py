...
REPLACEMENTS = [
    ...
    (r"from \.\.tasks import .*", "from dotmac.platform.tasks_simple import app as celery_app"),
    (r"from \.tasks import .*", "from dotmac.platform.tasks_simple import app as celery_app"),
    ...
    (r"CacheService", "# CacheService removed - use cache functions directly"),
    (r"create_cache_service", "# create_cache_service removed - use cache functions directly"),
    (r"InMemoryCache", "TTLCache  # from cachetools"),
    (r"RedisCache", "redis_client  # from caching module"),
    # Replace task decorators
    (r"@background_task", "@celery_app.task"),
    (r"@task", "@celery_app.task"),
]
