...
for module, stats in sorted(modules.items()):
    ...
    print(
        f"{module:<20} {stats['total']:>8} {stats['untested']:>10} {stats['partial']:>8} {tested:>8} {coverage:>9.1f}%"
    )

print("-" * 70)
tested_all = total_all - untested_all - partial_all
print(
    f"{'TOTAL':<20} {total_all:>8} {untested_all:>10} {partial_all:>8} {tested_all:>8} {tested_all/total_all*100 if total_all > 0 else 0:>9.1f}%"
)
print()
